      ...
      <div className='flex flex-col-reverse md:flex-row justify-center items-center gap-10 md:gap-20 mt-16 px-4 md:px-0' id='about'>
        ...
        <div className='w-full md:w-[60%] lg:w-[30%] text-center md:text-left'>
          ...
          <p className='text-[#777777] pt-3 md:pt-5 text-sm md:text-base'>
            Hi, I'm Alhan, a passionate Full Stack Developer with a strong focus on creating engaging and user-friendly web experiences. With a solid foundation in JavaScript, ReactJS, NextJS, NodeJS, ExpressJS, I enjoy bringing designs to life and ensuring seamless interactions on the web.
          </p>
          <p className='text-[#777777] pt-3 md:pt-5 text-sm md:text-base'>
            I have experience working on a variety of projects, from e-commerce websites to dynamic web applications, always striving for clean code, responsive design, and accessibility. My goal is to continuously learn and grow, adapting to the latest trends and technologies in full stack development.
          </p>
          <a href='/Alhan_Dilshad_Resume.pdf' download>
